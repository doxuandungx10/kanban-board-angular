...
export declare class NzRowDirective implements OnInit, OnChanges, AfterViewInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzRowDirective, "[nz-row],nz-row,nz-form-item", ["nzRow"], { "nzAlign": "nzAlign"; "nzJustify": "nzJustify"; "nzGutter": "nzGutter"; }, {}, never, never, false>;
}

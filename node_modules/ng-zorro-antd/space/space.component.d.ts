...
export declare class NzSpaceComponent implements OnChanges, OnDestroy, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzSpaceComponent, "nz-space, [nz-space]", ["NzSpace"], { "nzDirection": "nzDirection"; "nzAlign": "nzAlign"; "nzSplit": "nzSplit"; "nzWrap": "nzWrap"; "nzSize": "nzSize"; }, {}, ["items"], ["*"], false>;
}

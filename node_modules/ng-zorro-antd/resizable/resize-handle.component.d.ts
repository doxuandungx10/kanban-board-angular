...
export declare class NzResizeHandleComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzResizeHandleComponent, "nz-resize-handle, [nz-resize-handle]", ["nzResizeHandle"], { "nzDirection": "nzDirection"; }, { "nzMouseDown": "nzMouseDown"; }, never, ["*"], false>;
}

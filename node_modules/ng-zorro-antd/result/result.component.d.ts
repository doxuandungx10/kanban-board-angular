...
export declare class NzResultComponent implements OnChanges, OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzResultComponent, "nz-result", ["nzResult"], { "nzIcon": "nzIcon"; "nzTitle": "nzTitle"; "nzStatus": "nzStatus"; "nzSubTitle": "nzSubTitle"; "nzExtra": "nzExtra"; }, {}, never, ["[nz-result-icon]", "div[nz-result-title]", "div[nz-result-subtitle]", "nz-result-content, [nz-result-content]", "div[nz-result-extra]"], false>;
}

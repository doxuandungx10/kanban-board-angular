...
export declare class NzTextareaCountComponent implements AfterContentInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTextareaCountComponent, "nz-textarea-count", never, { "nzMaxCharacterCount": "nzMaxCharacterCount"; "nzComputeCharacterCount": "nzComputeCharacterCount"; "nzFormatter": "nzFormatter"; }, {}, ["nzInputDirective"], ["textarea[nz-input]"], false>;
}

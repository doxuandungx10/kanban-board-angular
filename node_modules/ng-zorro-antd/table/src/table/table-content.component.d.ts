...
export declare class NzTableContentComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTableContentComponent, "table[nz-table-content]", never, { "tableLayout": "tableLayout"; "theadTemplate": "theadTemplate"; "contentTemplate": "contentTemplate"; "listOfColWidth": "listOfColWidth"; "scrollX": "scrollX"; }, {}, never, ["*"], false>;
}

...
export declare class NzTrMeasureComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTrMeasureComponent, "tr[nz-table-measure-row]", never, { "listOfMeasureColumn": "listOfMeasureColumn"; }, { "listOfAutoWidth": "listOfAutoWidth"; }, never, never, false>;
}

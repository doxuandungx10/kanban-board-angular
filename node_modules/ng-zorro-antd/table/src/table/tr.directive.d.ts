...
export declare class NzTrDirective implements AfterContentInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTrDirective, "tr:not([mat-row]):not([mat-header-row]):not([nz-table-measure-row]):not([nzExpand]):not([nz-table-fixed-row])", never, {}, {}, ["listOfNzThDirective", "listOfCellFixedDirective"], never, false>;
}

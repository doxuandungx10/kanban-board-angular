...
export declare class NzTableCellDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTableCellDirective, "th:not(.nz-disable-th):not([mat-cell]), td:not(.nz-disable-td):not([mat-cell])", never, {}, {}, never, never, false>;
}

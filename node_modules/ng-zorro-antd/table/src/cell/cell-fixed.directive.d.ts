...
export declare class NzCellFixedDirective implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzCellFixedDirective, "td[nzRight],th[nzRight],td[nzLeft],th[nzLeft]", never, { "nzRight": "nzRight"; "nzLeft": "nzLeft"; "colspan": "colspan"; "colSpan": "colSpan"; }, {}, never, never, false>;
}

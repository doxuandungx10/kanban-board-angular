...
export declare class NzTextEditComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTextEditComponent, "nz-text-edit", ["nzTextEdit"], { "text": "text"; "icon": "icon"; "tooltip": "tooltip"; }, { "startEditing": "startEditing"; "endEditing": "endEditing"; }, never, never, false>;
}

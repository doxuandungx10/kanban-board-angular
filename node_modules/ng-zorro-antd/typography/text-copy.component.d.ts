...
export declare class NzTextCopyComponent implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTextCopyComponent, "nz-text-copy", ["nzTextCopy"], { "text": "text"; "tooltips": "tooltips"; "icons": "icons"; }, { "textCopy": "textCopy"; }, never, never, false>;
}

...
export declare abstract class AbstractTable implements OnInit, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<AbstractTable, never, never, { "prefixCls": "prefixCls"; "value": "value"; "locale": "locale"; "activeDate": "activeDate"; "showWeek": "showWeek"; "selectedValue": "selectedValue"; "hoverValue": "hoverValue"; "disabledDate": "disabledDate"; "cellRender": "cellRender"; "fullCellRender": "fullCellRender"; "canSelectWeek": "canSelectWeek"; }, { "valueChange": "valueChange"; "cellHover": "cellHover"; }, never, never, false>;
}

...
export declare class NzOverflowContainerComponent implements OnInit, AfterContentInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzOverflowContainerComponent, "nz-overflow-container", never, {}, {}, ["overflowSuffix", "overflowRest", "overflowItems"], ["*", "[appOverflowRest]", "[appOverflowSuffix]"], false>;
}

...
export declare class NzOptionItemComponent implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzOptionItemComponent, "nz-option-item", never, { "grouped": "grouped"; "customContent": "customContent"; "template": "template"; "disabled": "disabled"; "showState": "showState"; "label": "label"; "value": "value"; "activatedValue": "activatedValue"; "listOfSelectedValue": "listOfSelectedValue"; "icon": "icon"; "compareWith": "compareWith"; }, { "itemClick": "itemClick"; "itemHover": "itemHover"; }, never, never, false>;
}

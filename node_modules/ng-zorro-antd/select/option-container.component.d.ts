...
export declare class NzOptionContainerComponent implements OnChanges, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzOptionContainerComponent, "nz-option-container", ["nzOptionContainer"], { "notFoundContent": "notFoundContent"; "menuItemSelectedIcon": "menuItemSelectedIcon"; "dropdownRender": "dropdownRender"; "activatedValue": "activatedValue"; "listOfSelectedValue": "listOfSelectedValue"; "compareWith": "compareWith"; "mode": "mode"; "matchWidth": "matchWidth"; "itemSize": "itemSize"; "maxItemLength": "maxItemLength"; "listOfContainerItem": "listOfContainerItem"; }, { "itemClick": "itemClick"; "scrollToBottom": "scrollToBottom"; }, never, never, false>;
}

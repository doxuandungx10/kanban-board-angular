...
export declare class NzCommentComponent implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzCommentComponent, "nz-comment", ["nzComment"], { "nzAuthor": "nzAuthor"; "nzDatetime": "nzDatetime"; }, {}, ["actions"], ["nz-avatar[nz-comment-avatar]", "nz-comment-content", "*"], false>;
}

...
export declare class NzCalendarHeaderComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzCalendarHeaderComponent, "nz-calendar-header", ["nzCalendarHeader"], { "mode": "mode"; "fullscreen": "fullscreen"; "activeDate": "activeDate"; }, { "modeChange": "modeChange"; "yearChange": "yearChange"; "monthChange": "monthChange"; }, never, never, false>;
}

...
NzTabLinkDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.6", ngImport: i0, type: NzTabLinkDirective, deps: [{ token: i0.ElementRef }, { token: i1.RouterLink, optional: true, self: true }, { token: i1.RouterLinkWithHref, optional: true, self: true }], target: i0.ɵɵFactoryTarget.Directive });

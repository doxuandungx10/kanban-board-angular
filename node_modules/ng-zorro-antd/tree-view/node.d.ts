...
export declare class NzTreeNodeComponent<T> extends NzNodeBase<T> implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTreeNodeComponent<any>, "nz-tree-node:not([builtin])", ["nzTreeNode"], {}, {}, never, ["nz-tree-node-toggle, [nz-tree-node-toggle]", "nz-tree-node-checkbox", "nz-tree-node-option", "*"], false>;
}
export declare class NzTreeNodeDefDirective<T> extends CdkTreeNodeDef<T> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTreeNodeDefDirective<any>, "[nzTreeNodeDef]", never, { "when": "nzTreeNodeDefWhen"; }, {}, never, never, false>;
}
export declare class NzTreeVirtualScrollNodeOutletDirective<T> implements OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTreeVirtualScrollNodeOutletDirective<any>, "[nzTreeVirtualScrollNodeOutlet]", never, { "data": "data"; }, {}, never, never, false>;
}

...
export declare class NzTreeNodeOptionComponent<T> implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTreeNodeOptionComponent<any>, "nz-tree-node-option", never, { "nzSelected": "nzSelected"; "nzDisabled": "nzDisabled"; }, { "nzClick": "nzClick"; }, never, ["*"], false>;
}

...
export declare class NzTreeView<T> extends CdkTree<T> implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTreeView<any>, "ng-component", never, { "treeControl": "nzTreeControl"; "dataSource": "nzDataSource"; "nzDirectoryTree": "nzDirectoryTree"; "nzBlockNode": "nzBlockNode"; }, {}, never, never, false>;
}

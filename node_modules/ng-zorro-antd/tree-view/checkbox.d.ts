...
export declare class NzTreeNodeCheckboxComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTreeNodeCheckboxComponent, "nz-tree-node-checkbox:not([builtin])", never, { "nzChecked": "nzChecked"; "nzIndeterminate": "nzIndeterminate"; "nzDisabled": "nzDisabled"; }, { "nzClick": "nzClick"; }, never, never, false>;
}
